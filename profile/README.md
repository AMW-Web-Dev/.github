# AhmadMWaddah — Web Dev Projects

> A curated collection of web development projects built with Django, Python, and modern frontend technologies — from full-stack ERP systems to fintech dashboards and responsive UI templates.
...
|---------|-------------|-------|--------|
| [CRM](https://github.com/AMW-Web-Dev/crm) | Client & project management system for freelancers and small businesses. Features live search (HTMX), dashboard analytics (Chart.js), mobile-responsive cards, and role-based access. | Django 6.0, SQLite/PostgreSQL, HTMX, Chart.js | ✅ Complete |
...
| [Digital Wallet](https://github.com/AMW-Web-Dev/DigitalWallet) | Multi-portal fintech wallet with client/staff separation, atomic transactions, fraud detection, async PDF statement generation, and analytics dashboards. | Django 5.2, PostgreSQL, Celery, Redis, ReportLab | ✅ Complete |
...
| Project | Description |
|---------|-------------|
| [Constitution Starter](./Constitution_Starter.md) | Reusable project constitution template — defines roles, workflows, Git strategy, testing standards, and code quality rules. Used across all Django projects. |
...
|----------|-------------|
| **Backend** | Python 3.10–3.12, Django 4.2–6.0 |
| **Database** | PostgreSQL 15, SQLite (dev) |
| **Cache / Queue** | Redis 7, Celery 5 |
| **Frontend** | HTMX, Tailwind CSS, Pure CSS3, Vanilla JS, Chart.js, ReportLab |
| **Deployment** | Docker, Gunicorn, WhiteNoise, Render, Supabase |
| **Quality** | pytest, pytest-django, ruff, black, isort, pre-commit |
| **Infrastructure** | Docker Compose, Git (branch-per-phase workflow) |

---

## 🎯 Purpose

This organization consolidates all web development projects under one umbrella, keeping the main GitHub profile clean for Linux and Automation work while providing a dedicated home for Django, Python, and frontend projects.

---

## 📄 License

All projects are licensed under the **MIT License** unless otherwise noted. See individual project LICENSE files for details.
